 ...
 */
class IsRecordOwner extends AbstractDb
{
    /**
     * Error constants
     */
    ...
    protected $messageTemplates = [
        self::ERROR_RECORD_OWNERSHIP => 'You are not authorized to modify a record that is not yours',
    ];
    ...
    public function isValid($value)
    {
        ...
        if (empty($result[$this->field])) {
            ...
            $message = $this->messageTemplates[Self::ERROR_RECORD_OWNERSHIP];
